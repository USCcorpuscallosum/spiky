...
Map::Map(int width, int height, double point_spread, unsigned int seed) : m_centers_quadtree(AABB(Vec2(width/2,height/2),Vec2(width/2,height/2)), 1){
	map_width = width;
	map_height = height;
...
void Map::GeneratePoints(){
	PoissonDiskSampling pds(map_width, map_height, m_point_spread, 10);
